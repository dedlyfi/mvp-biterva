...
COMANDOS:
# 1. Apaga los contenedores y borra los volúmenes de docker
docker-compose down -v

# 2. BORRA la carpeta de datos de LND (Esto elimina la wallet expuesta)
# ¡Cuidado! Asegúrate de estar en la carpeta correcta antes de dar enter
rm -rf ./lnd-data

# 3. (Opcional) Si quieres limpiar también la base de datos de LNBits
rm -rf ./data

docker-compose down    
docker-compose up -d
Crear wallet:
docker exec -it lnbits-lnd lncli create

docker restart lnbits-main
docker logs lnbits-main

Generar address wallet:
docker exec -it lnbits-lnd lncli newaddress np2wkh

docker exec -it lnbits-lnd lncli walletbalance


docker exec -it lnbits-lnd lncli connect 03864ef025fde8fb587d989186ce6a4a186895ee44a926bfc370e2c366597a3f8f@3.33.236.230:9735
